...
description: "Find out how to create and organize your content quickly and intuitively in calmato theme."
resources:
- name: "featured-image"
...
Find out how to create and organize your content quickly and intuitively in **calmato** theme.
...
You may add the `<!--more-->` summary divider at the start of the article. Keep content that comes before the summary divider empty. Then **calmato** theme will use your description as the summary.
...
**calmato** theme supports mathematical formulas based on [$ \KaTeX $](https://katex.org/).
...
An extended Markdown syntax for **ruby annotation** is supported in **calmato** theme:
...
An extended Markdown syntax for **fraction** is supported in **calmato** theme:
...
**calmato** theme uses [Font Awesome](https://fontawesome.com/) as the icon library.
